...
public class GoBackOverBump extends WaitCommand {
    int wait;
  final int stop = 0;
  SwerveSubsystem swerveSubsystem;

  public GoBackOverBump(double seconds, SwerveSubsystem ss) {
    super(seconds);
    swerveSubsystem = ss;
    addRequirements(ss);
}
@Override
  ...
  public void execute() {
    ...
    swerveSubsystem.driveFieldOriented(new ChassisSpeeds(1 * direction, 0, 0));
    wait += 1;
  }
